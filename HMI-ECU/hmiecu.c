 /******************************************************************************
 *
 * Module: MC2 Application (HMI-ECU)
 *
 * File Name: hmiecu.c
 *
 * Description: Source file for the MC1 application
 *
...
#define INITIALIZED_FLAG 0x01 /*Flag is saved once the first run code is done*/
...
uint8 return_flag=0; /*Global variable used to know if the password has been entered for 3 times wrong & to be sent to MC2*/
...
/*
 *  Function Description :  for checking the entered password,
